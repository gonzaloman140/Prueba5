...
public class AddEditForoFragment2 extends Fragment {
    private static final String ARG_FORO_ID = "arg_foro_id";

    private static String mForoId;

    private static ForoDbHelper mForoDbHelper;

    private FloatingActionButton mSaveButton;
    private static TextInputEditText mTituloPublicacionField;

    private static TextInputEditText mNumeroTelefonoField;
    private static TextInputEditText mDetalleField;
    private static TextInputEditText mConversacionField;
    ...
    public AddEditForoFragment2() {
        // Required empty public constructor
    }

    public static AddEditForoFragment2 newInstance(String foroId) {
        AddEditForoFragment2 fragment = new AddEditForoFragment2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_add_edit_foro2, container, false);
    ...
    private void addEditForo() {
        ...
        Foro foro = new Foro(tituloPublicacion, detalle, numeroTelefono, conversacion, "");
    ...
    private static void showForo(Foro foro) {
    ...
    private class AddEditForoTask extends AsyncTask<Foro, Void, Boolean> {
        ...
        @Override
        protected Boolean doInBackground(Foro... foro) {
            if (mForoId != null) {
                return mForoDbHelper.updateForo(foro[0], mForoId) > 0;

            } else {
                return mForoDbHelper.saveForo(foro[0]) > 0;
            }
